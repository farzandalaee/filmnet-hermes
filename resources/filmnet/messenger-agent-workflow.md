...
- creates/updates the FilmNet Task ID in `state/active-tasks.md`
...
- FilmNet assistant remains responsible for updating `state/active-tasks.md` after delivery or replies.
...
- FilmNet assistant reads events and updates `state/active-tasks.md`.
