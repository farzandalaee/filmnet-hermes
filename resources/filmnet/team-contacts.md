...
Use `name-fa` for Persian greeting lines in internal message drafts.
Unknown values must stay as `[to be filled]`.
Mobile numbers must be stored as full numbers because SMS/call communication agents need them.
